...
SLAPE.write.table(PFP = PFPw,BEM = Dataset,filename = "tmp.csv",fdrth=5,exclcovth = 0,PATH_COLLECTION = KEGG_PATH)

SLAPE.serialPathVis(BEM = Dataset,PFP = PFPw,fdrth = 5,exCovTh = 80,PATH = 'res/',PATH_COLLECTION = KEGG_PATH)

SLAPE.coreComponents(PFP = PFPw,BEM = Dataset,fdrth = 5,exclcovth = 80,filename = 'res/core.components.pdf',PATH_COLLECTION = KEGG_PATH)
